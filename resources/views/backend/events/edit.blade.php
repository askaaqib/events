            ...
            <div class="card-body">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        <div class="form-group row">
                        {{ html()->label(__('validation.attributes.backend.events.events_name'))->class('col-md-2 form-control-label')->for('event_name') }}
                        
                            <div class="col-md-10">
                                {{ html()->text('event_name')
                                    ->class('form-control')
                                    ->placeholder(__('validation.attributes.backend.events.events_name'))
                                    ->attribute('maxlength', 191)
                        ...
                        @php
                        $currentdate = Carbon::createFromFormat("Y-m-d H:i:s",$events->start_date)->format("Y-m-d");
                        @endphp
                        <div class="form-group row">
